...
namespace Crystal
{
    ...
    {
        public bool ExcludeLeftOrientaion = false;
        public bool ExcludeRightOrientaion = false;
        public bool ExtendRightArea;
        #region Simulations
        /// <summary>
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            if (LastOrientation == ScreenOrientation.LandscapeLeft && ExcludeLeftOrientaion)
            {
                r.x = 0;
                r.width = Screen.width;
            }
                
            if (LastOrientation == ScreenOrientation.LandscapeRight && ExcludeRightOrientaion)
            {
                r.x = 0;
                r.width = Screen.width;
            }
            ...
            if (ExtendRightArea && LastOrientation == ScreenOrientation.LandscapeLeft)
            {
                anchorMax.x = 1f;
            }
            
            if (ExtendRightArea && LastOrientation == ScreenOrientation.LandscapeRight)
            {
                anchorMin.x = 0f;
            }
